 ...
 * <p><code>iron-list</code> should be used when a page has significantly more DOM nodes than the ones<br>visible on the screen. e.g. the page has 500 nodes, but only 20 are visible at the time.<br>This is why we refer to it as a <code>virtual</code> list. In this case, a <code>dom-repeat</code> will still<br>create 500 nodes which could slow down the web app, but <code>iron-list</code> will only create 20.</p>
 * <p>However, having an <code>iron-list</code> does not mean that you can load all the data at once.<br>Say, you have a million records in the database, you want to split the data into pages<br>so you can bring a page at the time. The page could contain 500 items, and iron-list<br>will only render 20.</p>
 */
public class IronList extends PolymerWidget {
     ...
     * @behavior IronList
     */
    public void setScrollTarget(JavaScriptObject value) {
    ...
    public void setMaxPhysicalCount(String value) {
        getPolymerElement().setAttribute("max-physical-count", value);
    }
    ...
    public void setFirstVisibleIndex(String value) {
        getPolymerElement().setAttribute("first-visible-index", value);
    }
    ...
    public void setScrollTarget(String value) {
        getPolymerElement().setAttribute("scroll-target", value);
    }
    ...
    public void setLastVisibleIndex(String value) {
        getPolymerElement().setAttribute("last-visible-index", value);
    }
