...
import com.vaadin.polymer.app.widget.event.AppResetLayoutEvent;
import com.vaadin.polymer.app.widget.event.AppResetLayoutEventHandler;
...
public class AppDrawer extends PolymerWidget {
     ...
     */
    public HandlerRegistration addAppResetLayoutHandler(AppResetLayoutEventHandler handler) {
        return addDomHandler(handler, AppResetLayoutEvent.TYPE);
    }
