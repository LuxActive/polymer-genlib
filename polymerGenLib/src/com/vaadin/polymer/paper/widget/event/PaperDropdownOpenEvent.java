...
public class PaperDropdownOpenEvent extends GwtEvent<PaperDropdownOpenEventHandler> {
    ...
    private com.vaadin.polymer.paper.event.PaperDropdownOpenEvent nativeEvent;

    public PaperDropdownOpenEvent(com.vaadin.polymer.paper.event.PaperDropdownOpenEvent nativeEvent) {
    ...
    public com.vaadin.polymer.paper.event.PaperDropdownOpenEvent getNativeEvent() {
        return nativeEvent;
    }
