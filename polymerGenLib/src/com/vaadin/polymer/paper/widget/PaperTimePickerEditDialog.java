 ...
 * 
 */
public class PaperTimePickerEditDialog extends PolymerWidget {
    /**
     * Default Constructor.
     */
    public PaperTimePickerEditDialog() {
       this("");
    }
     ...
     */
    public PaperTimePickerEditDialog(String html) {
        super(PaperTimePickerEditDialogElement.TAG, PaperTimePickerEditDialogElement.SRC, html);
    }

    /**
     * Gets a handle to the Polymer object's underlying DOM element.
     */
    public PaperTimePickerEditDialogElement getPolymerElement() {
        return (PaperTimePickerEditDialogElement) getElement();
    }
    ...
    /**
     * <p>Locale used for formatting times</p>
     *
     * JavaScript Info:
     * @property locale
     * @type string
    ...
    /**
     * <p>Open modal dialog containing the time picker</p>
     *
     * JavaScript Info:
     * @method open
     * 
