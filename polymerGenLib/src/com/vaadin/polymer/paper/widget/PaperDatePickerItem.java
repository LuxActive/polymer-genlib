 ...
 * </code></pre>
 */
public class PaperDatePickerItem extends PolymerWidget {
    /**
     * Default Constructor.
     */
    public PaperDatePickerItem() {
       this("");
    }
     ...
     */
    public PaperDatePickerItem(String html) {
        super(PaperDatePickerItemElement.TAG, PaperDatePickerItemElement.SRC, html);
    }

    /**
     * Gets a handle to the Polymer object's underlying DOM element.
     */
    public PaperDatePickerItemElement getPolymerElement() {
        return (PaperDatePickerItemElement) getElement();
    }
