...
public interface GoogleChartLoaderElement extends HTMLElement {
     ...
     * 
     */
    @JsProperty JavaScriptObject getPackages();
    /**
     * <p>Adds packages to the list of packages to load.</p>
     * <p>This is an array consisting of any Google Visualization package names.</p>
     *
     ...
     * 
     */
    @JsProperty void setPackages(JavaScriptObject value);
     ...
     */
    JavaScriptObject dataTable(Object data);
     ...
     * @return {JavaScriptObject}
     */
    JavaScriptObject query(String url, JavaScriptObject opt_options);
     ...
     * @return {JavaScriptObject}
     */
    JavaScriptObject fireOnChartEvent(JavaScriptObject chart, String eventName, boolean opt_once);
     ...
     * @return {JavaScriptObject}
     */
    JavaScriptObject dataView(JavaScriptObject data);
     ...
     * @return {JavaScriptObject}
     */
    JavaScriptObject create(String type, JavaScriptObject el);
