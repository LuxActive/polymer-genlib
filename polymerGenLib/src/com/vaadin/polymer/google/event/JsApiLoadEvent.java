 ...
 */
@JsType
public interface JsApiLoadEvent extends Event {

    static final String NAME = "js-api-load";


    public abstract class Listener implements EventListener {
        protected abstract void handleEvent(JsApiLoadEvent event);

        @Override
        public void handleEvent(Event event) {
            handleEvent((JsApiLoadEvent) event);
        }
    }
}
