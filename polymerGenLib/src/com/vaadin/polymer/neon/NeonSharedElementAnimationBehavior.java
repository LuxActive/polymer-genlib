...
public interface NeonSharedElementAnimationBehavior {
    ...
    public static final String TAG = "Polymer.NeonSharedElementAnimationBehavior";
    public static final String SRC = "neon-animation/neon-shared-element-animation-behavior.html";
